...
void _graphicsInit()
{
    ...
    Graphics_drawImage(&g_sContext, &JOYSTICK_BLUE, MENU_OPTION_OFFSET_X, MENU_OPTION_OFFSET_Y); for(j=0;j<2*CYCLES;j++){}
    Graphics_drawImage(&g_sContext, &JOYSTICK_BLACK, MENU_OPTION_OFFSET_X, MENU_OPTION_OFFSET_Y); for(j=0;j<2*CYCLES;j++){}
    Graphics_drawImage(&g_sContext, &ACCELEROMETER_BLUE, MENU_OPTION_OFFSET_X, MENU_OPTION_OFFSET_Y+16); for(j=0;j<2*CYCLES;j++){}
    Graphics_drawImage(&g_sContext, &ACCELEROMETER_BLACK, MENU_OPTION_OFFSET_X, MENU_OPTION_OFFSET_Y+16); for(j=0;j<2*CYCLES;j++){}
